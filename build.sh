...
KBUILD_LOUP_CFLAGS="-Wno-parentheses -Wno-memset-elt-size -Wno-bool-operation -Wno-tautological-compare -Wno-duplicate-decl-specifier -Wno-misleading-indentation -Wno-bool-compare -mtune=cortex-a53 -march=armv8-a+crc+simd+crypto -mcpu=cortex-a53 -O2" 
